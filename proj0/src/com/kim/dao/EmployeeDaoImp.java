...
public class EmployeeDaoImp implements EmployeeDao {
    ...
    public void getTransactions() throws SQLException {
        ...
        while (rs.next()) {
            ...
            System.out.println("______________________________________________________________________________");
                String cuAccounts = " Transaction ID: " + rs.getString(1) +
                        "    Account # " +
                        rs.getString(2) +
                        "   Amount  " +
                        "$ " + rs.getString(3) +
    ...
    public void userLogin(String username, String pw) throws SQLException {
        ...
        String validate = "select usertype, password from bank.user where usertype = ? AND password = ? ";
        PreparedStatement statement = connection.prepareStatement(validate);
        ...
        if (resultSet.next()) {
            ...
            System.out.println("Logged in, proceeding to Main Menu.");
            initialMenu();
