...
import static com.kim.dao.CustomerDaoFactory.getCustomerDao;
...
public class AccountOperations {
    ...
    public static void newBankAccount() throws SQLException {
        ...
        System.out.println(" Note: minimum starting balance is $5,000");
        while (!sc.hasNextInt()) {
            System.out.println();
            System.out.println("Invalid input type, try again:");
            sc.nextLine();
        ...
        BigDecimal minbalance = BigDecimal.valueOf(5000.00);

        while (startbalance.compareTo(minbalance) < 0) {
            System.out.println("Sorry, your account starting balance must be greater than or equal to $ 5,000.00");
            System.out.println();
            System.out.println("Please choose the amount you wish to deposit:");
    ...
    public static void bankAccountValidate() throws SQLException {
        ...
        while(run){
            ...
            System.out.println("   4. Post a money transfer.");
            System.out.println("   5. Accept money transfer.");
            System.out.println("   6. Logout and return to Customer Portal.");
            ...
            switch (input) {
                ...
                case 2:
                    ...
                    BigDecimal minDeposit = BigDecimal.valueOf(20.00);
                    while (depo.compareTo(minDeposit) < 0) {
                        System.out.println("Sorry, deposit amount must be greater than $20.");
                ...
                case 3:
                    ...
                    BigDecimal negativeBlocker = BigDecimal.valueOf(1.00);
                    while (withdraw.compareTo(negativeBlocker) < 0) {
                        System.out.println("Sorry, the minimum withdrawal amount is $1.00");
                ...
                case 4:
                    ...
                    /*BigDecimal minTransfer = BigDecimal.valueOf(500.00);
                    while (transferAmount.compareTo(minTransfer) < 0) {
                        System.out.println("Sorry, minimum transfer amount is $500.00");
                        System.out.println("Please enter transfer amount: ");
                        sc.next(); }
                    transferAmount = sc.nextBigDecimal();*/
                    System.out.println("Please enter the account number of the account you would like to transfer to:");
                    int target = sc.nextInt();
                    cDao.postTransfer(transferAmount, target, an);
                    break;

                case 5:
                    System.out.println("Welcome to 5ive Hive: our portal for secure funds transfer");
                    System.out.println("Checking for any pending transfers......");
                    cDao.processTransfer(an);
                    break;

                    case 6:
                    System.out.println("Goodbye, logging out of bank services..");
                    run = false;
                    customerMenu();
                    break;
